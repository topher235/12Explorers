package churt.a12explorers.FourChoice;
...
public class FourChoiceActivity extends Activity implements View.OnClickListener {

    private final static String TAG = FourChoiceActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_four_choice);
        ...
        //Grab items from xml
        question = (TextView) findViewById(R.id.four_choice_question);
        choice1 = (Button) findViewById(R.id.four_choice_btn1);
        choice2 = (Button) findViewById(R.id.four_choice_btn2);
        choice3 = (Button) findViewById(R.id.four_choice_btn3);
        choice4 = (Button) findViewById(R.id.four_choice_btn4);
        isCorrect = (TextView) findViewById(R.id.four_choice_is_correct);
        ...
        choice3.setText(questionList[0][3]);
        choice4.setText(questionList[0][4]);
        answer = questionList[0][5];
        isCorrect.setText("");
    ...
    public void onClick(View view) {
        switch(view.getId()) {
            ...
            case R.id.four_choice_btn2:
                ...
                break;
            case R.id.four_choice_btn3:
                if(choice3.getText().equals(answer)) {
                    userIsCorrect(choice3);
                } else {
                    userIsWrong(choice3);
                }
                break;
            case R.id.four_choice_btn4:
                if(choice4.getText().equals(answer)) {
                    userIsCorrect(choice4);
                } else {
                    userIsWrong(choice4);
                }
                break;
    ...
    private void setUpArray(AssetManager am) {
        try {
            InputStreamReader is = new InputStreamReader(am.open("fourchoicequestions.txt"));
    ...
    private Button actualAnswer() {
        if(choice1.getText().equals(answer)) {
            return choice1;
        } else if(choice2.getText().equals(answer)) {
            return choice2;
        } else if(choice3.getText().equals(answer)) {
            return choice3;
        } else {
            return choice4;
        }
    ...
    private void displayNextQuestion() {
        try {
            ...
            choice3.setText(questionList[numQuestionsAnsweredToday][3]);
            choice4.setText(questionList[numQuestionsAnsweredToday][4]);
            answer = questionList[numQuestionsAnsweredToday][5];
            isCorrect.setText("");
